...
class FakeLLMService:
    ...
    def enrich_subtitles(self, cues, correct, target_language, subtitle_mode):
        self.calls.append((cues, correct, target_language, subtitle_mode))
        return [
            SubtitleCue(
                index=1,
                start=0.0,
...
def test_run_subtitle_job_processes_video_with_injected_services(tmp_path):
    ...
    assert llm_service.calls[0][1:] == (True, "zh", "bilingual")
